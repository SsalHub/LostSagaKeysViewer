...
public class CommandKeySetting extends IntSetting {
     ...
     */
    private static final Pattern LEGACY_COMMAND_REGEX = Pattern
            .compile("\\[keycode=(\\d+),ctrl=(true|false),alt=(true|false)]");
    ...
    public boolean matches(int code) {
        return value != null && value.intValue() == CommandKeys.getExtendedKeyCode(code, false, CommandKeys.isCtrlDown,
                CommandKeys.isAltDown);
    }
    ...
    public boolean parse(String data) {
        if (data.equalsIgnoreCase("unbound")) {
            ...
            if (m.matches()) {
                ...
                update(CommandKeys.getExtendedKeyCode(value, false, Boolean.parseBoolean(m.group(2)),
