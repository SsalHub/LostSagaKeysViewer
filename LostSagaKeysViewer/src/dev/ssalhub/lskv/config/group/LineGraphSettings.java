...
import dev.ssalhub.lskv.config.legacy.LegacyGraphSetting;
...
import dev.ssalhub.lskv.config.setting.IntSetting;
import dev.ssalhub.lskv.panels.LineGraphPanel;
import dev.ssalhub.lskv.ui.editor.Editor;
import dev.ssalhub.lskv.ui.editor.LineGraphEditor;
...
public class LineGraphSettings extends GraphPanelSettings implements LegacyProxyStore {
    ...
    /**
     * Maximum graph y value that will be displayed. Any higher values are capped at
     * this value.
     */
