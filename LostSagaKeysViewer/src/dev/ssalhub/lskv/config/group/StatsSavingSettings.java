 ...
 */
package dev.ssalhub.lskv.config.group;
...
import dev.ssalhub.lskv.Statistics;
import dev.ssalhub.lskv.config.IndentWriter;
import dev.ssalhub.lskv.config.Setting;
import dev.ssalhub.lskv.config.SettingGroup;
import dev.ssalhub.lskv.config.legacy.LegacyProxyStore;
import dev.ssalhub.lskv.config.legacy.ProxySetting;
import dev.ssalhub.lskv.config.setting.BooleanSetting;
import dev.ssalhub.lskv.config.setting.LongSetting;
import dev.ssalhub.lskv.config.setting.PathSetting;
...
public class StatsSavingSettings extends SettingGroup implements LegacyProxyStore {
     ...
     */
    private final PathSetting autoDestination = new PathSetting("autoDestination",
            Objects.toString(System.getProperty("user.home"), "") + File.separator + "kpsstats");
    /**
     * The date time formatter pattern to use for the statistics auto saving file
     * name.
     */
     ...
     */
    private final LongSetting autoInterval = new LongSetting("autoInterval", 1, Long.MAX_VALUE,
     ...
     */
    private final PathSetting saveFile = new PathSetting("saveFile",
            Objects.toString(System.getProperty("user.home"), "") + File.separator + "stats.kpsstats");
    ...
    public boolean parse(Map<String, String> data) {
        return findAndParse(data, autoSave, autoDestination, autoFormat, autoInterval, saveOnExit, loadOnLaunch,
                saveFile);
    }
