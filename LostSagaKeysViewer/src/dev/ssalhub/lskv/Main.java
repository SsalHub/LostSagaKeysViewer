...
import dev.ssalhub.lskv.config.Version;
...
import dev.ssalhub.lskv.event.source.NativeHookInputSource;
import dev.ssalhub.lskv.layout.GridPanel;
import dev.ssalhub.lskv.layout.Layout;
import dev.ssalhub.lskv.panels.DataPanel;
import dev.ssalhub.lskv.panels.GraphPanel;
import dev.ssalhub.lskv.ui.dialog.MainDialog;
import dev.ssalhub.lskv.ui.listener.MainWindowListener;
...
public class Main {
    ...
    public static final void reconfigure() {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setSize(layout.getWidth() + insets.left + insets.right,
                    layout.getHeight() + insets.top + insets.bottom);
