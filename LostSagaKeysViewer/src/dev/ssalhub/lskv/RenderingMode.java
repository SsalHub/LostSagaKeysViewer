...
public enum RenderingMode {
    ...
    HORIZONTAL_TN("Text - value") {
        ...
        protected void setTitleDrawPositionImpl(FontMetrics metrics, Graphics2D g, Font font, BasePanel panel,
            ...
            point.move(
                    ...
                    Main.config.getBorderOffset() + insideOffset
                            + (getPanelInsideHeight(panel) + getHeight(g, font)) / 2);
        }
    ...
    DIAGONAL1("Text diagonally right above value") {
        ...
        protected void setTitleDrawPositionImpl(FontMetrics metrics, Graphics2D g, Font font, BasePanel panel,
                String title) {
            point.move(
                    Main.config.getBorderOffset() + insideOffset + getPanelInsideWidth(panel) - 1
