 ...
 */
package dev.ssalhub.lskv.panels;
...
import dev.ssalhub.lskv.ColorManager;
...
import dev.ssalhub.lskv.ui.editor.EditorProvider;
...
public abstract class BasePanel extends JPanel implements LayoutPosition, EditorProvider {
    ...
    public void paintComponent(Graphics g1) {
        ...
        // panel border
        g.drawImage(ColorManager.graph_upper_left, borderOffset, borderOffset, borderOffset + imageSize,
                borderOffset + imageSize, 0, 0, 4, 4, this);
        g.drawImage(ColorManager.graph_lower_left, borderOffset, this.getHeight() - borderOffset - imageSize,
                borderOffset + imageSize, this.getHeight() - borderOffset, 0, 0, 4, 4, this);
        g.drawImage(ColorManager.graph_upper_right, this.getWidth() - borderOffset - imageSize, borderOffset,
                this.getWidth() - borderOffset, borderOffset + imageSize, 0, 0, 4, 4, this);
        g.drawImage(ColorManager.graph_lower_right, this.getWidth() - borderOffset - imageSize,
                this.getHeight() - borderOffset - imageSize, this.getWidth() - borderOffset,
                this.getHeight() - borderOffset, 0, 0, 4, 4, this);
        g.drawImage(ColorManager.graph_side_left, borderOffset, borderOffset + imageSize, borderOffset + imageSize,
                this.getHeight() - borderOffset - imageSize, 0, 0, 4, 56, this);
        g.drawImage(ColorManager.graph_upper_middle, borderOffset + imageSize, borderOffset,
                this.getWidth() - borderOffset - imageSize, borderOffset + imageSize, 0, 0, 46, 4, this);
        g.drawImage(ColorManager.graph_lower_middle, borderOffset + imageSize,
                this.getHeight() - borderOffset - imageSize, this.getWidth() - borderOffset - imageSize,
                this.getHeight() - borderOffset, 0, 0, 46, 4, this);
        g.drawImage(ColorManager.graph_side_right, this.getWidth() - borderOffset - imageSize, borderOffset + imageSize,
                this.getWidth() - borderOffset, this.getHeight() - borderOffset - imageSize, 0, 0, 4, 56, this);
    }
