...
public class MainDialog extends JPanel {
    ...
    /**
     * Builds the left GUI panel that shows general info, main configuration and
     * check boxes.
     * 
    ...
    private JPanel buildLeftPanel() {
        ...
        JLabel info = new JLabel(
                "<html><body style='width:210px'>You can either configure the program on this screen or use the right <b>right click</b> menu after the program is already visible to see changes take effect in real time.</body></html>");
