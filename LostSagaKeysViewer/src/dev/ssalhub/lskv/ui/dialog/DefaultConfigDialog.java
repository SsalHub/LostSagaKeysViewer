...
import dev.ssalhub.lskv.ui.model.FilePathFormatterFactory;
...
public class DefaultConfigDialog extends JPanel {
     ...
     */
    private JTextField selectedFile = new JFormattedTextField(new FilePathFormatterFactory(),
            Objects.toString(ConfigLoader.getDefaultConfig(), ""));
    ...
    private DefaultConfigDialog() {
        ...
        add(new JLabel("You can configure a default configuration to be opened automatically on launch."),
