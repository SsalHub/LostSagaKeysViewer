...
import dev.ssalhub.lskv.config.ConfigLoader;
import dev.ssalhub.lskv.config.Configuration;
import dev.ssalhub.lskv.config.UpdateRate;
import dev.ssalhub.lskv.config.group.KeyPanelSettings;
import dev.ssalhub.lskv.ui.dialog.AboutDialog;
import dev.ssalhub.lskv.ui.dialog.ColorDialog;
import dev.ssalhub.lskv.ui.dialog.CommandKeysDialog;
import dev.ssalhub.lskv.ui.dialog.DefaultConfigDialog;
import dev.ssalhub.lskv.ui.dialog.KeysDialog;
import dev.ssalhub.lskv.ui.dialog.LayoutDialog;
import dev.ssalhub.lskv.ui.dialog.StatsSavingDialog;
...
public class Menu {
    ...
    protected static final void createMenu() {
        ...
        tAllKeys.addActionListener((e) -> {
            ...
            Main.keys.entrySet().removeIf(entry -> !CommandKeys.isMouseButton(entry.getKey())
                    && !Main.config.getKeys().contains(entry.getKey(), KeyPanelSettings::getKeyCode));
        });
    ...
    /**
     * Removes the system tray icon if present and makes the main frame visible
     * again.
     */
